    ...
    <>
      ...
      >
        ...
        >
          ...
          <li>
            <a href="#top" className="font-Ovo" onClick={toggleMenu}>
              Home
            </a>
          </li>
          <li>
            <a href="#about" className="font-Ovo" onClick={toggleMenu}>
              About me
            </a>
          </li>
          <li>
            <a href="#services" className="font-Ovo" onClick={toggleMenu}>
              Services
            </a>
          </li>
          <li>
            <a href="#work" className="font-Ovo" onClick={toggleMenu}>
              My Work
            </a>
          </li>
          <li>
            <a href="#contact" className="font-Ovo" onClick={toggleMenu}>
              Contac me
            </a>
          </li>
        </ul>
